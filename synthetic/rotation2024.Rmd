...
single_run_simulation = function(N,nc=3, fold_num = 1, CV,seed = NULL, k=4, 
                                 bs= 'bs',choice=c(1,5,7), raw = F){
  if(is.null(seed)){
    set.seed(seed)
  }
...
for (i in 1:nsim){
  ...
  # Not sure 100% but pretty sure this is a valid ATT estimator using psi?
